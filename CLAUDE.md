...
- Deployable stack (`recrypt-server`, `recrypt-cli`, `recrypt-storage-auth`): **AGPL-3.0-or-later**, with a commercial license from Identikey Inc. as the carve-out (`LICENSE-COMMERCIAL.md`).
